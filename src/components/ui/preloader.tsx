      ...
      >
        ...
        >
          ...
          >
            <span
              className={cn(
                "absolute left-1/2 top-0 rounded-full bg-purple-600 shadow-[0_0_14px_rgba(168,85,247,0.45)]",
                compact ? "h-2 w-2" : "h-2.5 w-2.5",
              )}
            />
            <span
              className={cn(
                "absolute left-1/2 top-1/2 rounded-full bg-cyan-500/80 shadow-[0_0_10px_rgba(34,211,238,0.35)] -translate-x-1/2 -translate-y-1/2",
