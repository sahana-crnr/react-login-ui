        ...
        <footer className="bg-black dark:bg-card text-white py-10 mt-auto w-full border-t border-border">
            <div className="max-w-8xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Your one-stop destination for all your shopping needs. Quality products at the best prices.</p>
                </div>
                <div>
                    <h3 className="text-xl font-bold text-purple-500 mb-4 ">Quick Links</h3>
                    <ul className="text-muted-foreground text-sm space-y-2">
                        <li><Link to="/home" className="hover:text-purple-500 transition-colors">Home</Link></li>
                        <li><Link to="/products" className="hover:text-purple-500 transition-colors">Products</Link></li>
                ...
                <div className="flex flex-col md:items-end">
                    <div className="w-full md:w-max">
                        ...
                        <form className="flex justify-center md:justify-start" onSubmit={e => e.preventDefault()}>
                            ...
                            <Input id="newsletter-email" name="email" autoComplete="email" type="email" placeholder="Enter your email" className="rounded-r-none text-foreground" />
