...
import { FaArrowLeft, FaShoppingCart, FaStar, FaTag, FaBolt } from "react-icons/fa";
...
export default function ProductDetails() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-2 md:p-4 pb-20">
            {/* Back Navigation */}
            ...
            <div className="max-w-[1200px] mx-auto bg-white flex flex-col md:flex-row shadow-sm rounded-2xl border border-gray-200">
                ...
                <div className="w-full md:w-2/5 p-4 md:p-6 border-r border-gray-100 flex flex-col items-center">
                    <div className="w-full h-80 md:h-96 flex justify-center items-center p-4 border border-gray-100 rounded-sm mb-4">
