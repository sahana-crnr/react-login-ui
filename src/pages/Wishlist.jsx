        ...
        <div className="bg-background text-foreground min-h-screen flex flex-col">
            ...
            <main className="flex-1 p-4 md:p-8 max-w-8xl mx-auto w-full">
                <div className="mb-8 border-b border-border pb-4">
                    ...
                    <p className="text-muted-foreground font-medium mt-1">{wishlistItems.length} {wishlistItems.length === 1 ? 'Item' : 'Items'} Saved</p>
                </div>

                {wishlistItems.length === 0 ? (
                    <div className="text-center py-20 flex flex-col items-center justify-center">
                        <FaHeartBroken className="text-6xl mb-4 text-muted-foreground opacity-70" />
